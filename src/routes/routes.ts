...
import { expressAuthentication } from './../middlewares/authTsoa';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/business/create',
            ...
            ...(fetchMiddlewares<RequestHandler>(BusinessController.prototype.create)),

            function BusinessController_create(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"body","name":"req","required":true,"dataType":"any"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/business/filter',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(BusinessController)),
            ...(fetchMiddlewares<RequestHandler>(BusinessController.prototype.list)),

            function BusinessController_list(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"body","name":"req","required":true,"dataType":"any"},
            };
